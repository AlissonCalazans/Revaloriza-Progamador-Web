...
using DesafioReval.Models;

namespace DesafioReval.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,razaosocial,nomefantasia,cnpj,inscrisaoe,nomeresp,email,telefone,cep,cidade,estado")] ClienteModel clienteModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,razaosocial,nomefantasia,cnpj,inscrisaoe,nomeresp,email,telefone,cep,cidade,estado")] ClienteModel clienteModel)
        {
